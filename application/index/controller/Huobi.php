...
class Huobi
{
    ...
    private $AccessKeyId = '907865b4-uymylwhfeg-d6fa0ebd-ac7eb';
    private $SECRET_KEY = '1d82737e-b53d721f-83111acf-1e31f';
    private $api = '';
    public $api_method = '';
    public $req_method = '';
    ...
    // 查询某个订单的成交明细
    function get_order_matchresults($order_id = 0, $postdata) {
